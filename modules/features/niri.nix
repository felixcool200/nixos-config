{
  ...
  # ── Niri wrapper module (config for the wrapped niri package) ────
      ...
      in {
        ...
        binds = {
          ...
          "Mod+d".spawn-sh = self.mkWhichKeyExe config.pkgs [
            ...
            { key = "f"; desc = "Brave"; cmd = "brave"; }
            { key = "d"; desc = "Discord"; cmd = "discord"; }
            { key = "m"; desc = "Spotify"; cmd = "spotify"; }
        ...
        in {
          "w0" = settings; "w1" = settings; "w2" = settings;
          "w3" = settings; "w4" = settings; "w5" = settings;
          "w6" = settings; "w7" = settings; "w8" = settings;
          "w9" = settings;
        };
  ...
  # ── NixOS module (the DE option, like hyprland) ─────────────────
  ...
  in {
    ...
    # System packages for niri desktop
