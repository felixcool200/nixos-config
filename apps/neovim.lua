...
require('lazy').setup({
  ...
  -- NOTE: FELIX START
  {
    ...
    opts = {
      -- Have three tabs for git, current open windows and git changes.
  ...
  -- Mutliline editing.
  {
    ...
    branch = "master",
    init = function()
      -- Set keybindings using global vars (Vim-style)
      vim.g.VM_maps = {
...

  {
    ...
    config = function()
      ...
      -- Neovim. In this setup, we assume they're already installed on your system
      -- (e.g., via Nix or another package manager).
      ...
      -- Set up each server with lspconfig
